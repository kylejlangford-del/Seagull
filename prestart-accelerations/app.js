(() => {
  ...
  const DEFAULT_ROWS = [
    { tws:'6',  group:'TACK', color:'#a6dd86', entryAbove:'2.05', entryBelow:'1.40', distToLine:'70',      vamosBefore:'15', vamosTime:'24', vamosAfter:'33', ttkLastTack:'18', timeLastTack:'40(18 TTK)', latestBoardUp:'-',  buildAngle:'100', charge:'17',   chargeSpeed:'', killRatio:'1:3', noGo1:'-',      noGo2:'0-180',     killHigh1:'18', killHigh2:'' },
    { tws:'7',  group:'TACK', color:'#8fd2df', entryAbove:'2.05', entryBelow:'1.40', distToLine:'100',     vamosBefore:'16', vamosTime:'24', vamosAfter:'32', ttkLastTack:'18', timeLastTack:'40(18 TTK)', latestBoardUp:'-',  buildAngle:'100', charge:'17',   chargeSpeed:'25.8', killRatio:'1:3', noGo1:'-',      noGo2:'0-180',     killHigh1:'18', killHigh2:'' },
    { tws:'8',  group:'TACK', color:'#4e9fd6', entryAbove:'2.05', entryBelow:'1.40', distToLine:'100',     vamosBefore:'17', vamosTime:'24', vamosAfter:'31', ttkLastTack:'18', timeLastTack:'40(18 TTK)', latestBoardUp:'20', buildAngle:'90',  charge:'15',   chargeSpeed:'27.5', killRatio:'1:3', noGo1:'-',      noGo2:'0-180',     killHigh1:'17', killHigh2:'' },
    { tws:'9',  group:'GYBE', color:'#f0a35c', entryAbove:'2.05', entryBelow:'1.40', distToLine:'170',     vamosBefore:'22', vamosTime:'29', vamosAfter:'36', ttkLastTack:'18', timeLastTack:'40(18 TTK)', latestBoardUp:'20', buildAngle:'90',  charge:'15',   chargeSpeed:'29', killRatio:'1:3', noGo1:'-',      noGo2:'0-180',     killHigh1:'17', killHigh2:'' },
    { tws:'10', group:'GYBE', color:'#b8e29a', entryAbove:'1.50', entryBelow:'1.30', distToLine:'200',     vamosBefore:'24', vamosTime:'30', vamosAfter:'36', ttkLastTack:'15', timeLastTack:'35(15 TTK)', latestBoardUp:'15', buildAngle:'90',  charge:'15',   chargeSpeed:'30.5', killRatio:'1:3', noGo1:'-',      noGo2:'>80 120<',  killHigh1:'16', killHigh2:'' },
    { tws:'11', group:'GYBE', color:'#8ecb7c', entryAbove:'1.50', entryBelow:'1.30', distToLine:'200',     vamosBefore:'24', vamosTime:'30', vamosAfter:'36', ttkLastTack:'15', timeLastTack:'35(15 TTK)', latestBoardUp:'15', buildAngle:'90',  charge:'13',   chargeSpeed:'31.8', killRatio:'1:3', noGo1:'-',      noGo2:'-',         killHigh1:'16', killHigh2:'' },
    { tws:'12', group:'GYBE', color:'#5fa85a', entryAbove:'1.50', entryBelow:'1.30', distToLine:'200',     vamosBefore:'24', vamosTime:'30', vamosAfter:'36', ttkLastTack:'15', timeLastTack:'35(15 TTK)', latestBoardUp:'10', buildAngle:'90',  charge:'12',   chargeSpeed:'32.9', killRatio:'1:3', noGo1:'-',      noGo2:'-',         killHigh1:'16', killHigh2:'' },
    { tws:'13', group:'GYBE', color:'#d7de6a', entryAbove:'1.50', entryBelow:'1.30', distToLine:'300',     vamosBefore:'32', vamosTime:'37', vamosAfter:'42', ttkLastTack:'15', timeLastTack:'35(15 TTK)', latestBoardUp:'10', buildAngle:'90',  charge:'10',   chargeSpeed:'34', killRatio:'1:3', noGo1:'-',      noGo2:'-',         killHigh1:'16', killHigh2:'' },
    { tws:'14', group:'GYBE', color:'#f4d94f', entryAbove:'1.40', entryBelow:'1.30', distToLine:'300',     vamosBefore:'31', vamosTime:'36', vamosAfter:'41', ttkLastTack:'12', timeLastTack:'30(12 TTK)', latestBoardUp:'10', buildAngle:'70',  charge:'10',   chargeSpeed:'34.9', killRatio:'1:3', noGo1:'-',      noGo2:'-',         killHigh1:'17', killHigh2:'' },
    { tws:'15', group:'GYBE', color:'#f7c343', entryAbove:'1.40', entryBelow:'1.30', distToLine:'300',     vamosBefore:'30', vamosTime:'35', vamosAfter:'40', ttkLastTack:'12', timeLastTack:'30(12 TTK)', latestBoardUp:'8',  buildAngle:'70',  charge:'8',    chargeSpeed:'35.7', killRatio:'1:3', noGo1:'80-100', noGo2:'-',         killHigh1:'18', killHigh2:'' },
    { tws:'16', group:'GYBE', color:'#f2994a', entryAbove:'1.20', entryBelow:'1.10', distToLine:'300',     vamosBefore:'29', vamosTime:'34', vamosAfter:'39', ttkLastTack:'12', timeLastTack:'30(12 TTK)', latestBoardUp:'6',  buildAngle:'70',  charge:'7',  chargeSpeed:'36.3', killRatio:'1:3', noGo1:'80-100', noGo2:'-',         killHigh1:'18', killHigh2:'' },
    { tws:'17', group:'GYBE', color:'#ec7c3c', entryAbove:'1.20', entryBelow:'1.10', distToLine:'300-400', vamosBefore:'33', vamosTime:'38', vamosAfter:'43', ttkLastTack:'10', timeLastTack:'30(12 TTK)', latestBoardUp:'6',  buildAngle:'70',  charge:'6',  chargeSpeed:'36.9', killRatio:'1:3', noGo1:'',        noGo2:'80-100',    killHigh1:'19', killHigh2:'' },
    { tws:'18', group:'GYBE', color:'#e05c4e', entryAbove:'1.20', entryBelow:'1.10', distToLine:'300-400', vamosBefore:'33', vamosTime:'38', vamosAfter:'43', ttkLastTack:'10', timeLastTack:'30',         latestBoardUp:'6',  buildAngle:'70',  charge:'6',  chargeSpeed:'', killRatio:'1:3', noGo1:'',        noGo2:'80-100',    killHigh1:'19', killHigh2:'' },
  ];
  ...
  const COLUMNS = [
    ...
    { key:'charge',        label:'Charge time (secs)',             defaultVisible:true },
